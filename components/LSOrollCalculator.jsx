      ...
      <div style={{maxWidth: '28rem', margin: '0 auto', padding: '1rem'}}>
        ...
        <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '1rem'}}>
          ...
          <div style={{display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0.125rem'}}>
            <span style={{fontSize: '10px', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.05em'}}>v1.2</span>
            <span style={{fontSize: '10px', padding: '0.125rem 0.375rem', borderRadius: '0.25rem', backgroundColor: friday ? 'rgba(249, 115, 22, 0.2)' : 'rgba(34, 197, 94, 0.2)', color: friday ? '#F97316' : '#22c55e', fontWeight: '500'}}>
          ...
          <div style={{borderRadius: '0.75rem', border: '1px solid ' + getBgColor(calculation.color, 0.3), backgroundColor: getBgColor(calculation.color, 0.1), padding: '0.75rem', marginBottom: '0.75rem'}}>
            ...
            {calculation.weeksToRoll > 0 ? (
              <div style={{borderRadius: '0.5rem', padding: '0.625rem', marginTop: '0.5rem', backgroundColor: getBgColor(calculation.color, 0.15)}}>
                ...
                {calculation.advice && (
                  <p style={{fontSize: '10px', color: 'rgba(148, 163, 184, 0.9)', marginTop: '0.375rem', margin: '0.375rem 0 0 0'}}>{calculation.advice}</p>
                )}
              </div>
            ) : (
